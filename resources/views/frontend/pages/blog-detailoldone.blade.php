        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <img src="{{$post->photo}}" class="img-fluid mb-5" alt="{{$post->photo}}">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author">
                                            <a href="javascript:void(0);">
                                                ...
                                                By {{$post->author_info['name']}}</a>
                                        <a href="javascript:void(0);"><i class="fa fa-calendar"></i>
                                        {{$post->created_at->format('M d, Y')}}</a>
                                        <a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{$post->allComments->count()}})</a></span>
                                    </div>
