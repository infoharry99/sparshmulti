...
.owl-carousel{
   ...
   <div class="container">
    <div class="product-page" style="margin-bottom: 10rem;margin-top: 10rem;">
        <!-- Left: Image -->
