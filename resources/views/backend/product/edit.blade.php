    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input id="sold_by" type="text" name="sold_by" placeholder="Enter Sold By"  value="{{$product->sold_by}}" class="form-control">
          @error('sold_by')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="name_of_manufacture" type="text" name="name_of_manufacture" placeholder="Enter Name of Manufacture"  value="{{$product->name_of_manufacture}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <input id="address_of_manufacture" type="text" name="address_of_manufacture" placeholder="Enter Name of address"  value="{{$product->address_of_manufacture}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
